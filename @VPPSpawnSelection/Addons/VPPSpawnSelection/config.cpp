class CfgMods
{
	class VPPSpawnSelection
	{
		dir="VPPSpawnSelection";
		picture="";
		action="";
		hideName=1;
		hidePicture=1;
		name="Vanilla++ Spawn Selection";
		credits="DaOne & GravityWolf & MrMaffen";
		author="DaOne & GravityWolf & MrMaffen";
		authorID="420420";
		inputs="VPPSpawnSelection/data/modded_Inputs.xml";
		version="Version 1.0";
		extra=0;
		type="mod";
		dependencies[]=
		...
		class defs
		{
			class imageSets
			{
				files[]=
				{
					"VPPSpawnSelection/GUI/Textures/vppss_icons.imageset",					
					"VPPSpawnSelection/GUI/Textures/vppss_models.imageset"
				};
			};
...
class cfgVPPCharacterScenes
{
	class ChernarusPlus
	{
		...
		{
			target[]={6604,5,2422};
			position[]={6564,65,2458};
			fov=1.2236;
		};
		class loccation_2
		{
			target[]={8746,200,2954};
			position[]={8446,255,2866};
			fov=1.2236;
		};
		class loccation_3
		{
			target[]={6907,0,11425};
			position[]={7222,255,11315};
			fov=1.2236;
		};
	};
};
